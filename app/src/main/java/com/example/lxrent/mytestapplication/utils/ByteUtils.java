package com.example.lxrent.mytestapplication.utils;
...
public class ByteUtils {
	...
	static String charmap = ".12345abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
...
//				.putLong(Long.parseLong(amount));
	...
	public static byte[] writerKey(String key) {
        com.example.lxrent.mytestapplication.utils.ByteBuffer bf = new com.example.lxrent.mytestapplication.utils.ByteBuffer();
